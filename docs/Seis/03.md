...
|:---:|:---:|
|$\mu$|$\mu^*=\mu_R+i\mu_I$|
|$\beta=\sqrt{\frac{\mu}{\rho}}$|$\beta^*=\sqrt{\frac{\mu^*}{\rho}}$|
|$\alpha=\sqrt{\frac{\lambda+2\mu}{\rho}}=\sqrt{\frac{\lambda+2\mu}{\rho}}$|$\alpha^*=\sqrt{\frac{\lambda^*+2\mu^*}{\rho}}$|
:::
...
转换为时间域的波形为
$$
\frac{1}{\sqrt{2\pi}}\int_{-\infty}^{+\infty} exp(-\frac{\omega x}{2Q c}) exp(i\omega x/c) e^{-i\omega t} d\omega
=
\frac{1}{\pi}\frac{\frac{x}{2cQ}}{(\frac{x}{2cQ})^2+(\frac{x}{c}-t)^2}
$$
...
$$
\beta^*=c(\omega)(1-\frac{i}{2Q_\mu})
$$
$$
\frac{1}{\beta^*}=\frac{1}{c(\omega)}(1+\frac{i}{2Q_\mu})
$$
...
<i class="iconfont icon-href"></i> [更适合北大宝宝体质的 Tsh Lab 踩坑记](https://arthals.ink/blog/tsh-lab)
<i class="iconfont icon-href"></i> [CSAPP Lab5 实验记录 —— Shell Lab（实验分析 + 完整代码）](https://blog.csdn.net/qq_37500516/article/details/120836083)
<i class="iconfont icon-href"></i> [CSAPP 课程 Lab5 Shell Lab](https://zhuanlan.zhihu.com/p/662872049)

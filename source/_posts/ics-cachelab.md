...
![](img/ics-cachelab/cache_map_32x32.png)
...
![](img/ics-cachelab/cache_map_64x64.png)
...
![](img/ics-cachelab/cache_map_60x68.png)
...
<i class="iconfont icon-href"></i> [更适合北大宝宝体质的 Cache Lab 踩坑记](https://arthals.ink/blog/cache-lab)
<i class="iconfont icon-href"></i> [CSAPP: Cachelab 全注释+思路和建议](https://zhuanlan.zhihu.com/p/456858668)

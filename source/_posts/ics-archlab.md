...
![](/img/ics-archlab/execute-stage.png)
...
<i class="iconfont icon-href"></i> [更适合北大宝宝体质的 Arch Lab 踩坑记](https://arthals.ink/blog/arch-lab)
<i class="iconfont icon-href"></i> [CSAPP - archlab](https://mcginn7.github.io/2020/02/21/CSAPP-archlab)
<i class="iconfont icon-href"></i> [Introduction-to-Computer-Systems-2025Fall-PKU](https://github.com/elainafan/Introduction-to-Computer-Systems-2025Fall-PKU)
